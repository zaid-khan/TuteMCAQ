...
using System.Data;
public partial class AdminTuteMCAQ_Admin_TutorialAdd : System.Web.UI.Page
{
    ...
    public void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        if (FileUpload1.HasFile)
        {
            ...
            {
                string path = @"C:\Users\Bateman\Documents\Visual Studio 2015\WebSites\TuteMCAQ\AdminTuteMCAQ\PDFs\" + FileUpload1.FileName;
                ...
                try
                {
                    ...
                    {
                        SqlCommand cmd = new SqlCommand("spInsertTutorial", con);
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@TuteName", txtName.Text);
                        cmd.Parameters.AddWithValue("@TuteDesc", txtDesc.Text);
                        cmd.Parameters.AddWithValue("@FileName", FileUpload1.FileName);
                        cmd.Parameters.AddWithValue("@Type", DropDownList1.SelectedValue);
                        con.Open();
                        int tuteid = Convert.ToInt32(cmd.ExecuteScalar());
                        lblMessage.ForeColor = System.Drawing.Color.Green;
                        lblMessage.Text = "File upload successfull with ID : " + tuteid + "!";
